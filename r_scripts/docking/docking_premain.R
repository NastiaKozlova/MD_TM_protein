...
v_part<-paste0(part_start,"MD_analysis/docking/docking_first/")
...
for(q in 1:length(v_temp)){
    ...
    setwd(part)
    print(part)
    df_ligand<-read.csv(paste0(part_start,"start/ligand_field.csv"),stringsAsFactors = F)
