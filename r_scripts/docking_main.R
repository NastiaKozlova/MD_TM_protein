...
for (i in 1:nrow(df_receptor)) {
  system(command = paste0(part_start,"programs/mgltools_x86_64Linux2_1.5.7/bin/pythonsh ",part_start,"programs/mgltools_x86_64Linux2_1.5.7/MGLToolsPckgs/AutoDockTools/Utilities24/prepare_receptor4.py -r ",
